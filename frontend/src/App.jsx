...
const TEAM = [
  ...
  { name: "Yerragunfla Kameswara Sai Srikar", role: "Co-Founder · Cloud & AI", specialty: "AI/ML Lead", photo: "/srikar.png", initial: "S", accent: "#22c55e", tags: ["AI/ML Lead", "Cloud & AWS", "Automation"] },
  ...
  return (
    <div className="iv-vid-wrap">
      ...
      <div className="iv-vid-frame">
        <video ref={vRef} src="/demo.mp4" muted loop playsInline />
      </div>
    </div>
  );
}
