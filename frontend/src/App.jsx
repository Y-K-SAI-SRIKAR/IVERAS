...
function App() {
  ...
  // This is triggered by the “Ask IVERAS Ai” button
  ...
  return (
    ...
    >
      ...
      {/* AI CHAT SIDEBAR - RENDERED AT ROOT LEVEL */}
      <AiChatSidebar isOpen={aiChatOpen} onClose={handleAiChatClose} />
    </div>
  );
}
